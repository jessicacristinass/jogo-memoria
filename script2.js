...
var jogador = 1; //determina o jogador na função player

var paresC = 0; //fala quantos pares certos 

var jog1 = 0; //pontuação jogador 1
var jog2 = 0; //pontuação jogador 2
...
function Iniciar(){
    ...
    btn.remove(); //remove a div dos botões

    player(); //chama a função player
            ...
            bloco.addEventListener("click", function() { //adiciona nas peças o evento do click
              ...
              if(valorC == -1){ //vai conferir se o valorC está inalterado (se estiver, esse foi o primeiro click)
                ...
                console.log("errado");
                  ...
                  if(jogador % 2 != 0){ //adiciona 1 ponto na pontuação de quem acertou
                    let pont = document.querySelector("#pontuacao");
                    jog1++ 
                    pont.innerHTML = "";
                    pont.innerHTML = `Jogador verde: ${jog1}; Jogador vermelho: ${jog2}`;
                  } else {
                    let pont = document.querySelector("#pontuacao");
                    jog2++ 
                    pont.innerHTML = "";
                ...
                if(paresC == paresT){ //confere se finalizou o jogo de acordo com a quantidade de pares
                    ...
                    fim.addEventListener("click", function(){ /*adciona um evento que faz a pagina voltarpara index quando aperta em
                    qualquer lugar da tela*/
                        window.location = "index.html";
                    })

                    //vê quem ganhou e deix a tela da sua cor (menos no empate)
                    if(jog1>jog2){
                      let body = document.querySelector("body");
                      setTimeout(function(){body.style.backgroundColor = "green";}, 1500);

                      let ganhou = document.querySelector("#ganhou");
                      ganhou.innerHTML = "Jogador verde ganhou!"
                    } else if(jog2>jog1) {
                      let body = document.querySelector("body");
                      setTimeout(function(){body.style.backgroundColor = "red";}, 1500);

                      let ganhou = document.querySelector("#ganhou");
                      ganhou.innerHTML = "Jogador vermelho ganhou!"
                    } else {
                      let ganhou = document.querySelector("#ganhou");
                      ganhou.innerHTML = "Empate"
                    }
                }
              }
